    ...
    >
      ...
      <Box sx={{ width: "100%", height: "270px" }}>
        ...
        >
          ...
          alignSelf="flex-start"><Typography className="tworem" variant="h3" style={{fontWeight:"bold"}} >20g, 24Kt Lord Balaji Gold Coin </Typography></Grid>
